...
int main(int argc, char **argv)
{
    ...
    // 遍历/Users/losehu/Downloads/830_result/
    for (int i = 11; i <= 26; i++)
    {
std::string base = "/Users/losehu/Downloads/830_result";

std::ostringstream oss1, oss2;
oss1 << base << "/" << std::setw(2) << std::setfill('0') << i << ".pcd";
oss2 << base << "/" << i << ".jpg";

input_pcd_dir    = oss1.str();
input_photo_path = oss2.str();
        output_path = "./result.png";
        extrinsic_path = "./extrinsic_yuyan.txt";
        threshold_lidar = 300000000;
