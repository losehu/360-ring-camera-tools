...
public:
    ...
    bool operator()(const T *_q, const T *_t, T *residuals) const
    {
        ...
        std::cout << "sbsbsbsbsbs" << residuals[0] + residuals[1] << std::endl;
...
int main()
{
    ...
    string lidar_path = "/Users/losehu/Downloads/Pano_Video/calib/yuyan_point.txt"; // 雷达标注点
    // string lidar_path = "../fake_lidar.txt"; // 雷达标注点

    string photo_path = "/Users/losehu/Downloads/Pano_Video/calib/yuyan.txt";        // 全景标注点
    string extrinsic_path = "./extrinsic_yuyan.txt";    // 输出的外参路径
    string vaild_path = "/Users/losehu/Downloads/830_result/"; // 验证的全景图
